...
class ScrollTimeline:UIView, UIScrollViewDelegate
{
    ...
    override init(frame: CGRect)
    {
        ...
        timeline.add(Tween(target: fire, duration: 0.25, ease: Ease.none, delay: 0.8, keys: [\UIView.frame : nFrame]))
        ...
        timeline.add(Tween(target: sun, duration: 1.0, ease: Ease.none, delay: 0.5, keys: [\UIView.frame : nFrame]))
        ...
        timeline.add(Tween(target: moon, duration: 1.0, ease: Ease.none, delay: 1.5, keys: [\UIView.frame : nFrame]))
        ...
        timeline.add(Tween(target: earth, duration: 2.5, ease: Ease.none, delay: 0.85, keys: [\UIView.frame : nFrame]))
        ...
        timeline.add(Tween(target: spaceman, duration: 1.0, ease: Ease.none, delay: 1.5, keys: [\UIView.frame : nFrame]))
        ...
        timeline.add(Tween(target: comet, duration: 1.0, ease: Ease.none, delay: 2.5, keys: [\UIView.frame : nFrame]))
        ...
        timeline.add(Tween(target: mars, duration: 1.0, ease: Ease.none, delay: 3.5, keys: [\UIView.frame : nFrame]))
        ...
        timeline.add(Tween(target: ufo, duration: 0.75, ease: Ease.none, delay: 4.5, keys: [\UIView.frame : nFrame]))
        ...
        timeline.add(Tween(target: jupyter, duration: 1.5, ease: Ease.none, delay: 5.0, keys: [\UIView.frame : nFrame]))
        ...
        timeline.add(Tween(target: saturn, duration: 1.5, ease: Ease.none, delay: 7.0, keys: [\UIView.frame : nFrame]))
