...
public class TimelineInspector:UIView, TimelineObserver
{
    ...
    func makeRoundRect(rect:CGRect, cornerRadius:CGFloat) -> CGPath
    {
    ...
    override public func draw(_ rect: CGRect)
    {
        ...
        {
            //Text paths
            let textPath = getFontPath(string:"\(indexSecond)", fontSize:12.0)
            let transformTextPath = flipPathVertically(path:textPath)
        ...
        for (index, control) in timeline.controls.enumerated()
        {
            ...
            let path:CGPath =  makeRoundRect(rect:CGRect(x:CGFloat(control.getTween().delay) * scale,
    ...
    //TODO:move to utils.
    func getFontPath(string:String, fontSize:CGFloat) -> CGPath
    {
    ...
    func flipPathVertically(path:CGPath) -> CGPath
    {
